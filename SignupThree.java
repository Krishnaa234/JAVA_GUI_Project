...
public class SignupThree extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == submit) {
            ...
            String cardnumber = "" + Math.abs((random.nextLong() % 90000000L) + 5040936000000000L);//ATM first 8 number initialized
            ...
            //and it way cause exceptions so need exceptional handling because database is an external entity here
            try {
